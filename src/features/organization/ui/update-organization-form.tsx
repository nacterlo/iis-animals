...
import { Loader2Icon, RadioTowerIcon, SaveIcon, XIcon } from "lucide-react"
import { useOrganizationUpdate } from "../model/use-organization-update"
...
export function UpdateOrganizationForm({
    ...
    // const onSubmit = form.handleSubmit(updateOrganization);
    ...
    return (
        <form onSubmit={onSubmit}>
            <FieldGroup>
                <FieldSet className="p-4 grid grid-cols-[1.2fr_2fr]">
                    <div>
                        <FieldLegend>Общая информация</FieldLegend>
                        <FieldDescription>
                            Перечень общих данных организации
                        </FieldDescription>
                    </div>
            ...
            <Separator />
            <FieldGroup>
                <FieldSet className="px-2 py-4 grid grid-cols-[1.2fr_2fr]">
                    <div>
                        <FieldLegend>Адреса организации</FieldLegend>
                        <FieldDescription>
                        ...
                        {addressListFields.map((field, index) => (
                            <Field key={field.id} className="border-2 border-primary/50 p-2 rounded-2xl">
                                ...
                                <InputGroupAddon align="inline-end">
                                    ...
                                    >
                                        <XIcon />
                                        Удалить {field.addressKindCode === "1" ? "адрес регистрации" : field.addressKindCode === "2" ? "адрес фактический" : "адрес почтовый"}
                                    </InputGroupButton>
                                </InputGroupAddon>
                            </Field>
                        ))}
            ...
            <FieldGroup>
                <FieldSet className="px-2 py-4 grid grid-cols-[1.2fr_2fr]">
                    <div>
                        <FieldLegend>Контакты организации</FieldLegend>
                        <FieldDescription>
            ...
            <div className="px-2 py-4">
                <div className="flex direction-alternate-reverse items-center justify-end gap-2">
                    ...
                    <Button
                        ...
                        className='dark:bg-green-500 dark:hover:bg-green-400 bg-green-600 hover:bg-green-500'
                    >
                        {updatingOrganization ? (
                            <>
